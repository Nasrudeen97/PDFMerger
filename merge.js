...
const mergePdf = async (p1, p2) => {
  await merger.add(p1, '2 to 4');  //merge all pages. parameter is the path to file and filename.
  await merger.add(p2, '1 to 3'); // merge only page 2
  ...
  await merger.save(`Public/${file}.pdf`); //save under given name and reset the internal document
  return file
